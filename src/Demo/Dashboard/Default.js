				...
				<Navbar collapseOnSelect expand="lg" bg="dark" variant="dark">
					...
					<Navbar.Collapse id="responsive-navbar-nav">
						<Nav className="mr-auto">
							<Nav.Link href="#features">Loan</Nav.Link>
							<Nav.Link href="#pric">Hire Purchase</Nav.Link>
							<Nav.Link href="#pricin">Investment</Nav.Link>
							<Nav.Link href="#prici">Guarantors/Guarantees</Nav.Link>
							<NavDropdown
							...
							>
								<NavDropdown.Item href="#action/3.1">
									X-Life Cover Program
								</NavDropdown.Item>
								<NavDropdown.Item href="#action/3.2">
									Micro Pension Scheme for Farmer
								</NavDropdown.Item>
							</NavDropdown>
							<NavDropdown
